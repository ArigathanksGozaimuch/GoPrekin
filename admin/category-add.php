        ...
        <form action="../backends/admin/cat-add.php" method="post">
            ...
            <div class="row">
                <div class="col s6" style="">
                            ...
                            <label for="name" style="color: white;"><b>Nama Kategori :</b></label>
                            </div>
                </div>
                <div class="col s6" style="">
                            <div class="input-field">
                            <input id="short_desc" name="short_desc" type="text" class="validate" style="color: white; width: 70%">
                            <label for="short_desc" style="color: white;"><b>Deskripsi Singkat :</b></label>
                            </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <label for="long_desc" style="color: white;"><b>Deskripsi Lengkap :</b></label>
                </div>

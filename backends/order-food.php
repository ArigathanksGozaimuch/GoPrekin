...
if (!isset($_SESSION['user']) || !isset($_SESSION['user_id'])) {
	$_SESSION['msg'] = "Anda harus masuk terlebih dahulu sebelum memesan!";
	header('location: ../foods.php');
	exit();
}

if (!isset($_REQUEST['id'])) {
	$_SESSION['msg'] = "Produk makanan salah! Silahkan coba lagi!";
	header('location: ../foods.php');
	exit();
}
...
$order_id = "GPREK" . strval(mt_rand(1000000, 9999999));
...
if ($query->execute([$order_id, $user_id, $food_id, $user_name, $timest])) {
	...
	$_SESSION['msg'] = 'Pesanan Diterima! ID Pesanan Anda Adalah: '.$order_id;
